        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group text-center bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                    ...
                    <p class="text-gray-600 font-medium"> (35)3421-7397</p>
                </div>
                ...
                <div class="group text-center bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                    ...
                    <p class="text-gray-600 font-medium">Rua Cel Otávio Meyer, 160, Loja 326 – Centro, Pouso Alegre – MG, 37550-068</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="https://www.instagram.com/alfadronessolucoes?igsh=ZnYzemZkdnk3ZWg=" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-red-600 transition-colors duration-200 group">
                            <svg class="w-6 h-6 transform transition-transform duration-200 group-hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="text-gray-600">@alfadronessolucoes</span>
                    </div>
                </div>
            </div>
