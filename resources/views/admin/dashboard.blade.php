        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute -top-1 -right-1 w-4 h-4 bg-blue-100 rounded-full flex items-center justify-center">
                ...
                <div class="lg:col-span-2 bg-white rounded-xl shadow-lg border border-gray-100">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-6">
                            <div>
                                <h3 class="text-lg font-bold text-gray-900">Tendência de Vendas</h3>
                                <p class="text-sm text-gray-600 mt-1">Últimos 7 dias</p>
                            </div>
                            <div class="flex items-center space-x-2">
                                <div class="w-3 h-3 bg-green-500 rounded-full"></div>
                                <span class="text-sm text-gray-600">+12% vs semana anterior</span>
                            </div>
                        </div>
                        ...
                        <div class="h-64 flex items-end justify-between space-x-2">
                            <div class="flex flex-col items-center space-y-2">
                                <div class="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t-lg h-16"></div>
                                <span class="text-xs text-gray-500">Seg</span>
                            </div>
                            <div class="flex flex-col items-center space-y-2">
                                <div class="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t-lg h-24"></div>
                                <span class="text-xs text-gray-500">Ter</span>
                            </div>
                            <div class="flex flex-col items-center space-y-2">
                                <div class="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t-lg h-20"></div>
                                <span class="text-xs text-gray-500">Qua</span>
                            </div>
                            <div class="flex flex-col items-center space-y-2">
                                <div class="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t-lg h-32"></div>
                                <span class="text-xs text-gray-500">Qui</span>
                            </div>
                            <div class="flex flex-col items-center space-y-2">
                                <div class="w-8 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t-lg h-28"></div>
                                <span class="text-xs text-gray-500">Sex</span>
                            </div>
                            <div class="flex flex-col items-center space-y-2">
                                <div class="w-8 bg-gradient-to-t from-green-500 to-green-300 rounded-t-lg h-36"></div>
                                <span class="text-xs text-gray-500">Sáb</span>
                            </div>
                            <div class="flex flex-col items-center space-y-2">
                                <div class="w-8 bg-gradient-to-t from-green-500 to-green-300 rounded-t-lg h-40"></div>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <span class="bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded-full">2 novos</span>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start space-x-3 p-3 bg-orange-50 rounded-lg border border-orange-200">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-600 mt-1">3 produtos com estoque crítico</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-600 mt-1">Pedido #12345 aguardando</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3 p-3 bg-green-50 rounded-lg border border-green-200">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm font-medium text-gray-900">Sistema OK</p>
                                    <p class="text-xs text-gray-600 mt-1">Todos os serviços funcionando</p>
                                </div>
                            </div>
                        </div>

                        <div class="mt-6">
                            <button class="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-4 rounded-lg text-sm font-medium transition-colors duration-200">
                ...
                <div class="p-8">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-xs text-gray-500">Sistema ativo</span>
                        </div>
                    </div>
                ...
                <div class="p-8">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <a href="#" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
                                Ver todos
                            </a>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100">
                <div class="p-12 text-center">
                    ...
                    <a href="{{ route('home') }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors duration-200">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mt-8">
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100">
                    <div class="p-6">
                        <h3 class="text-lg font-bold text-gray-900 mb-4">Última Atividade</h3>
                        <div class="space-y-3">
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                                <div class="flex-1">
                                    <p class="text-sm text-gray-900">Produto adicionado</p>
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                                <div class="flex-1">
                                    <p class="text-sm text-gray-900">Estoque atualizado</p>
                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100">
                    <div class="p-6">
                        <h3 class="text-lg font-bold text-gray-900 mb-4">Resumo Financeiro</h3>
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-center">
                                <div>
                                    <p class="text-lg font-semibold text-gray-900">R$ 8.200</p>
                                    <p class="text-xs text-gray-600">Receita</p>
                                </div>
                                <div>
                                    <p class="text-lg font-semibold text-gray-900">R$ 4.250</p>
                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <div class="flex items-center space-x-4">
                            <div class="flex items-center space-x-2">
                                <div class="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
                                <span class="text-sm text-gray-600">Sistema Alfa Drones v1.0</span>
                            </div>
                            <div class="h-4 w-px bg-gray-300"></div>
                            <span class="text-sm text-gray-500">Última sincronização: {{ now()->format('d/m/Y H:i:s') }}</span>
                        </div>
                        <div class="flex items-center space-x-6">
                            <a href="#" class="text-sm text-gray-500 hover:text-gray-700 transition-colors">Suporte</a>
                            <a href="#" class="text-sm text-gray-500 hover:text-gray-700 transition-colors">Documentação</a>
                            <a href="#" class="text-sm text-gray-500 hover:text-gray-700 transition-colors">Logs do Sistema</a>
                        </div>
                    </div>
                </div>
            </div>
