    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Edite as informações do produto: {{ $product->name }}</p>
            </div>
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('inventory.update', $product) }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <button type="button" onclick="removeCurrentImage()" class="mt-2 text-sm text-red-600 hover:text-red-500">Remover imagem atual</button>
                                ...
                                <div id="image-preview" class="mt-3 hidden">
                                    ...
                                    <button type="button" onclick="removeImage()" class="mt-2 text-sm text-red-600 hover:text-red-500">Remover nova imagem</button>
                                </div>
                                @error('image')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="flex justify-end space-x-4">
                            ...
                            <button type="submit"
                                class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg text-sm font-medium transition duration-200">
                                💾 Atualizar Produto
                            </button>
                        </div>
                    </form>
